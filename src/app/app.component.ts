...
export class AppComponent implements OnInit, OnDestroy {
  ...
  public langs = ['en', 'zh', 'es', 'ja', 'ko', 'nl', 'pt', 'ru', 'th', 'tr', 'uk'];
  ...
  constructor(
    ...
    this.selectedLanguage = translate.getBrowserLang().match(/en|zh|es|ja|ko|nl|pt|ru|th|tr|uk/) ? translate.getBrowserLang() : 'en';
